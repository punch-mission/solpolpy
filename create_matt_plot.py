...
def create_plot(data, title='title', lower=5, upper=99.0, fontsize=16, nan=None, abs0=None):
    '''
    ...
    if abs0 != None:
        ...
        plotmin=np.nanpercentile(data, lower)
        plotmax=np.nanpercentile(data, upper)
    else:
        plotmin=np.percentile(data, lower)
        plotmax=np.percentile(data, upper)
